...
export const eventsTable = sqliteTable('events', {
  ...
  receivedAt: integer('received_at', { mode: 'timestamp' }).$defaultFn(
    () => new Date(),
  ),
  status: text('status', {
    enum: [
...
export const attributionsTable = sqliteTable('attributions', {
  ...
  attributedAt: integer('attributed_at', { mode: 'timestamp' }).$defaultFn(
    () => new Date(),
  ),
});
...
export const privacySettingsTable = sqliteTable('privacy_settings', {
  ...
  gdprCompliant: integer('gdpr_compliant', { mode: 'boolean' })
    .notNull()
    .default(false),
  ccpaCompliant: integer('ccpa_compliant', { mode: 'boolean' })
    .notNull()
    .default(false),
...
export const consentRecordsTable = sqliteTable('consent_records', {
  ...
  givenAt: integer('given_at', { mode: 'timestamp' }).$defaultFn(
    () => new Date(),
  ),
